...
This project makes the following data transformations:

- Combines the training and test datasets from the data source.
- Combines the subject and activity with measurement data.
- Eliminates all but the mean and standard deviation (std) for each 
  of 14 measurements.
